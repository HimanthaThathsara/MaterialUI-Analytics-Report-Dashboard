// This is ELECTRICITY Chart component from the react-environment-chart library.
// Export as ELECTRICITY CHART and you can access calling this function.
// Electricity is the Import Tag name
// Update the height:(Number) and value:(Number).
    ...
    >
        <CardContent>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '100%' }}>
                <Electricity height={225} value={50} tips={['dry', 'comfort', 'wet']}  />  
            </Box>
        </CardContent>
    </Card>
);
